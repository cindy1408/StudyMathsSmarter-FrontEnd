...
function homePage(){
    return (
      ...
      <div className="homePage">
            ...
            <MainBody2  title="Testimonials " subText="Using the decodeMaths website is helping our pupils to improve their final scores, and they are enjoying the rapid feedback of the automatic marking. It motivates the less able and offers real challenge to the high-flyers. 

Shelley Squadratics, Headteacher at Pi Squared Secondary School
"/>
            <MainBody imageSrc={PupilTeacher} title="A-Levels " subText="Our A-Level section includes a quiz which is a great tool for revising for any upcoming AS/A-Level mocks or exams. The decodeMaths revision packs are designed to help students self-serve their independent learning. Packs include a curated set of revision lessons, homework tasks, and online worksheets that offer targeted revision in the run up to exams.
"/>
